...
export default function Experience() {
  ...
  return (
    <div className="relative w-full max-w-[755px] mx-auto mt-16 flex flex-col md:flex-row gap-20 font-manrope">
      {/* Experience Section */}
      <section className="w-full md:w-[355px] mx-auto flex flex-col md:flex-col gap-9">
      <header>
